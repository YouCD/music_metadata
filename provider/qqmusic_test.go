...
func TestQQMusicProvider_GetLyrics(t *testing.T) {
	provider := NewQQMusicProvider()
...
func TestQQMusicProvider_GetCover(t *testing.T) {
	provider := NewQQMusicProvider()
...
func TestQQMusicProvider_Name(t *testing.T) {
	provider := NewQQMusicProvider()
